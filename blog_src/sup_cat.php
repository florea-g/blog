...
<body>
	...
	<div class="container" style="max-width:300px">
      ...
      <form class="form-signin" role="form" action="sup_categ.php" method="post">
        <h2 class="form-signin-heading"> Supprimer une categorie </h2>
        <select name="class" class="form-control">
		 <option selected>Supprimer une categorie</option>
