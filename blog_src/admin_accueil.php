...
?>
                ...
                <hr>
				<a class="btn btn-danger" href="delete_post.php?action=delete_p&id_post=<?php echo (string) $donnees['id_post'];?>" > <i class="icon-trash icon-white"></i> Delete </a>
                ...
                <button type="button" class="btn btn-info btn-large" style="margin-left:600px;" onclick="<?php echo "display_comm".(string) $count."()" ;?>;return false">Comments</button>   
                    ...
                    <div class="well comm_class_hide" id="<?php echo (string) $count;?>">
                        ...
                        <form role="form" method="post" action="admin_accueil.php" id="form">
						...
						?>
                        <h3> 
						<a class="btn btn-danger" href="delete_post.php?action=delete_c&id_com=<?php echo (string) $show['id_com']?>"> <i class="icon-trash icon-white"></i> Delete </a>
